...
class EC2Engine : public rgw::auth::s3::AWSEngine {
  ...
  std::string sign(const std::string& secret, const std::string& string_to_sign) const;
  std::pair<boost::optional<std::string>, int> get_secret_from_keystone(const std::string& user_id, const boost::string_view& access_key_id) const;
public:
